...
import { Alert, Box, Button, Card, Dialog, Divider, Grid, Stack, Typography } from '@mui/material';
...
import {
  ...
  getCandidateProfessionalDetails,
  searchLocation,
  setCandidateData,
...
const AddEditProfessionalDetailModal = ({ isOpenModal }) => {
  // states
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      await dispatch(editProfessionalDetails(editCandidateId, payload));
      isSubmitted.onTrue();
    } catch (err) {
      console.log(err);
    }
  ...
  useEffect(() => {
    ...
    if (isSubmitted.value && !formErr) {
      toast.success('Professional details edited successfully!');
...
export default AddEditProfessionalDetailModal;
