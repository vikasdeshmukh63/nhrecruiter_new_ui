...
import { Button, Dialog, Divider, Grid, Typography, Box, Stack } from '@mui/material';
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      if (type === CONSTANTS.EDIT) {
        ...
        await dispatch(editWorkExperienceDetails(candidateIdData?.cand_org_id, payload));
      } else {
        await dispatch(addWorkExperienceDetails(candidateIdData?.cand_org_id, payload));
      }
      isSubmitted.onTrue();
    } catch (err) {
      console.log(err);
